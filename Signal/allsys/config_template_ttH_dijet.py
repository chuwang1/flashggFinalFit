...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/cms/store/group/phys_higgs/cmshgg/zhjie/output/output_XMASS/opt/YEAR/root/addsys/ws_ttH_CAT_YMASS',
  'procs':'auto', # if auto: inferred automatically from filenames
  'cats':'auto', # if auto: inferred automatically from (0) workspace
  'ext':'dcb_%s_res_ttH_dijet_MXMASS_MYMASS_CAT'%_year,
