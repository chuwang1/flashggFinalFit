...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/cms/store/group/phys_higgs/cmshgg/zhjie/output/output_1000_boost/opt/2017/root/addsys/ws_gghh_cat0_250',
  'procs':'auto', # if auto: inferred automatically from filenames
  'cats':'auto', # if auto: inferred automatically from (0) workspace
  'ext':'dcb_%s_boost_masscut_M2000_M250_cat0'%_year,
