...
do
    ...
    y=${newfile##*'_'}
 if [ "$y" -le 150 ]; then
    		python3 RunBackgroundScripts.py --inputConfig $file --mode fTestParallel --binWidth  10. --do2d  1 
		# echo "python3 RunBackgroundScripts.py --inputConfig $file --mode fTestParallel --binWidth  10."
    		...
    		python3 RunBackgroundScripts.py --inputConfig $file --mode fTestParallel --binWidth  20.  --do2d  1 
