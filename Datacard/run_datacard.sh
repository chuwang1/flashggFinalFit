...
do
    ...
    cat=${cat##*'_'}  
    echo $cat
    python3 RunYields.py --inputWSDirMap 2018=/eos/cms/store/group/phys_higgs/cmshgg/zhjie/output/output_1000/opt/2018/root/addsys/ws_gghh_"$cat"_$i,2017=/eos/cms/store/group/phys_higgs/cmshgg/zhjie/output/output_1000/opt/2017/root/addsys/ws_gghh_"$cat"_$i,2016pre=/eos/cms/store/group/phys_higgs/cmshgg/zhjie/output/output_1000/opt/2016pre/root/addsys/ws_gghh_"$cat"_$i,2016post=/eos/cms/store/group/phys_higgs/cmshgg/zhjie/output/output_1000/opt/2016post/root/addsys/ws_gghh_"$cat"_$i  --sigModelWSDir /afs/cern.ch/user/c/chuw/chuw/bbgg/CMSSW_14_1_0_pre4/src/flashggFinalFit/Signal/outdir_packaged_mergeyears_resolved_M1000_M"$i"_"$cat"  --bkgModelWSDir /afs/cern.ch/user/c/chuw/chuw/bbgg/CMSSW_14_1_0_pre4/src/flashggFinalFit/Background/outdir_1000_M400/ --cats resolved_"$cat" --procs gghh --batch local --mergeYears --doSystematics --ignore-warnings --ext sys_resolved_combine_M1000_"$cat"_M$i 
...
combine -M AsymptoticLimits -m 125 -n boost_masscut_$i  Datacard_sys_boost_masscut_combined_M$i.txt --run expected
