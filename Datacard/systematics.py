...
experimental_systematics = [
                ...
                # {'name':'JESAbsoluteMPFBias','title':'CMS_JESAbsoluteMPFBias','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESAbsoluteScale','title':'CMS_JESAbsoluteScale','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESAbsoluteStat','title':'CMS_JESAbsoluteStat','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # {'name':'JESFlavorQCD','title':'CMS_JESFlavorQCD','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESFragmentation','title':'CMS_JESFragmentation','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESPileUpDataMC','title':'CMS_JESPileUpDataMC','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESPileUpPtBB','title':'CMS_JESPileUpPtBB','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESPileUpPtEC1','title':'CMS_JESPileUpPtEC1','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # {'name':'JESPileUpPtEC2','title':'CMS_JESPileUpPtEC2','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # {'name':'JESPileUpPtHF','title':'CMS_JESPileUpPtHF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESPileUpPtRef','title':'CMS_JESPileUpPtRef','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESRelativeBal','title':'CMS_JESRelativeBal','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESRelativeFSR','title':'CMS_JESRelativeFSR','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESRelativeJEREC1','title':'CMS_JESRelativeJEREC1','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESRelativeJEREC2','title':'CMS_JESRelativeJEREC2','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESRelativeJERHF','title':'CMS_JESRelativeJERHF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESRelativePtBB','title':'CMS_JESRelativePtBB','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESRelativePtEC1','title':'CMS_JESRelativePtEC1','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # {'name':'JESRelativePtEC2','title':'CMS_JESRelativePtEC2','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # {'name':'JESRelativePtHF','title':'CMS_JESRelativePtHF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESRelativeSample','title':'CMS_JESRelativeSample','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # {'name':'JESRelativeStatEC','title':'CMS_JESRelativeStatEC','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # {'name':'JESRelativeStatFSR','title':'CMS_JESRelativeStatFSR','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # {'name':'JESRelativeStatHF','title':'CMS_JESRelativeStatHF','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # {'name':'JESSinglePionECAL','title':'CMS_JESSinglePionECAL','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESSinglePionHCAL','title':'CMS_JESSinglePionHCAL','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'JESTimePtEta','title':'CMS_JESTimePtEta','type':'factory','prior':'lnN','correlateAcrossYears':0},
