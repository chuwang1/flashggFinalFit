...
parser.add_argument('--year', required=True, type=str, help="Input year")
args = parser.parse_args()
tfile = ROOT.TFile("/eos/user/c/chuw/Reweight/GluGluToHHTo2G2l2nu_node_"+args.input+"_13TeV_HHWWggTag_2_"+args.year+".root")
if (args.year == "2018"):
    ...
    SM_tfile = ROOT.TFile("/eos/user/a/atishelm/ntuples/HHWWgg_flashgg/January_2021_Production/2016/Signal/FL_NLO_2016_hadded/GluGluToHHTo2G2l2nu_node_cHHH1_2016.root")
...
Selections="(((Leading_Photon_pt/CMS_hgg_mass) > 1/3. && (Subleading_Photon_pt/CMS_hgg_mass) > 1/4. ) && dipho_pt >91)"
hist_SM= TH1F("hist_SM","hist_SM",80,100,180)
tree.Project("hist_unreweight","CMS_hgg_mass","weight")
SM_tree.Project("hist_SM","CMS_hgg_mass","weight*"+Selections)
tree.Project("hist_reweighted","CMS_hgg_mass","weight_"+args.input+"*weight*"+Selections)
...
SM_tree.Project("hist_SM_MHH","genMhh","weight*"+Selections)
tree.Project("hist_reweighted_MHH","genMhh","weight_"+args.input+"*weight*"+Selections)
