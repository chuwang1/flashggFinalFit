...
def get_options():
  ...
  parser.add_option('--binWidth', dest='binWidth', default='std', help="Which script to run. Options: ['fTestOnly','fTestParallel','bkgPlotsOnly']")
  parser.add_option('--do2d', dest='do2d', default='0', help="Which script to run. Options: ['fTestOnly','fTestParallel','bkgPlotsOnly']")
...
if opt.inputConfig != '':
  if os.path.exists( opt.inputConfig ):
    ...
    options['mass_low']                 = 100
    options['mass_up']                  = 180
    options['binWidth']                  = opt.binWidth
    options['do2d']                  = opt.do2d
    # Delete copy of file
