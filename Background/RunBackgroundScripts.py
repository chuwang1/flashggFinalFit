...
def get_options():
  ...
  parser.add_option('--mass_low', dest='mass_low', default=100, help="dijet fit") 
  parser.add_option('--mass_up', dest='mass_up', default=180, help="dijet fit") 
...
if opt.inputConfig != '':
  if os.path.exists( opt.inputConfig ):
    ...
    options['mass_low']                 = opt.mass_low
    options['mass_up']                  = opt.mass_up
    # Delete copy of file
