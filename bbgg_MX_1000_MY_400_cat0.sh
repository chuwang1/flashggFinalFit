...
python3 RunPackager.py --cats resolved_cat0 --exts dcb_resolved_M1000_M400_cat0_2017,dcb_resolved_M1000_M400_cat0_2018,dcb_resolved_M1000_M400_cat0_2016pre,dcb_resolved_M1000_M400_cat0_2016post --batch local  --massPoints 125 --mergeYears --outputExt packaged_mergeyears_resolved_M1000_M400_cat0
